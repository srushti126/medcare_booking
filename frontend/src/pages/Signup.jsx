...
const Signup = () => {
    ...
    const handleFileInputChange = async(event)=>{
      ...
      //later we will use cloudinary to upload 
    };
      ...
      <div className="max-w-[1170px] mx-auto ">
        <div className='grid grid-cols-1 lg:grid-cols-2'>
          ...
          <div className="mb-5 flex items-center justify-between">
            ...
            <div className="mt-7">
            <button
            disabled={loading && true} type='submit' className='w-full bg-primaryColor text-white text-[18px] lading-[30px] rounded-lg px-4 py-3'>{loading ? <HashLoader size={35} color="#ffffff" /> : 'Sign Up'}</button>
          </div>
