    ...
    <div>
      ...
      <div className='mt-12'>
        ...
        <ul className='pt-4 md:p-5'>
         ...
         <li key={index} className='flex flex-col sm:flex-row sm:justify-between sm:item-end md:gap-5 mb-[30px]'>
         <div>
            <span className='text-irisBlueColor text-[15px] leading-6 font-semibold'> {formateDate(item.startingDate)} - {formateDate(item.endingDate)}
            </span>
