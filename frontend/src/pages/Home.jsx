      ...
      <div className='container'>
        ...
        <div>
          <div className='lg:w-[570px]'>
           ...
           <p className='text__para'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Excepturi consequuntur doloremque illo facere non nesciunt culpa ipsa velit alias et quos dolore repudiandae maxime voluptates, ex accusantium, commodi dolores ut!</p>
      ...
      <section>
        <div className='container'>
          <div className='lg:w-[470px] mx-auto'>
            ...
            <p className='text__para text-center'>World Class Care For everyone. Out Health System Offers Unmatched. Expert health care.</p>
          </div>
      ...
      <section>
        <div className="container">
          ...
          <div className='xl:w-[670px]'>
            <h2 className='heading'>Get Virtual Treatment
            <br/> Anytime </h2>
            <ul className='pl-4'>
              <li className='text__para'>
                1. Schedule the Appointment Directly.</li>
                <li className='text__para'>
                2. Serch for your Physician here, and contact their office.</li>
                <li className='text__para'>
             ...
             <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px]  md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:pb-[26px] rounded-[10px]'>
              ...
              <div className='flex items-center justify-between'>
                <div className='flex item-center gap-[6px] lg:gap-3'>
                  ...
                  <p className='text-[10px] leading-[10px] lg:text-[14px] lg:leading-5 text-textColor font-[600]'>12:26AM</p>
                </div>
                <span className='w-5 h-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center bg-yellowColor rounded py-1 px-[6px] lg:py-3 lg:px-[9px]'>
                  <img src={videoIcon} alt=''/>
                </span>
              </div>
              <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px] text-[8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4 rounded-full'> Consultaion </div>
