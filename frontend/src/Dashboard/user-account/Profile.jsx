    ...
    <div className="mt-10">
       <form onSubmit={submitHandler}>
          ...
          <div className="mb-5 flex items-center justify-between">
            ...
            <div className="mt-7">
            <button
            disabled={loading && true} type='submit' className='w-full bg-primaryColor text-white text-[18px] lading-[30px] rounded-lg px-4 py-3'>{loading ? <HashLoader size={35} color="#ffffff" /> : 'Update'}
            </button>
          </div>
