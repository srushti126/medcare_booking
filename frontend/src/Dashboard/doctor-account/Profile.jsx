        ...
        <div className="mb-5">
            <div className="grid grid-cols-3 gap-5 mb-[30px]">
                ...
                <div>
                  ...
                  value={formData.specialization} onChange={handleInputChange} className="form__input py-3.5 ">
            ...
            {formData.qualifications?.map((item, index)=>(<div key={index}>
                ...
                <div className="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        value={item.startingDate} className="form__input" 
                    ...
                    <div>
                        ...
                        value={item.endingDate} className="form__input"
                        onChange={e=>handleQualificationChange(e, index)} />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-5 mt-5 ">
                    <div>
                        ...
                        value={item.degree} className="form__input" 
                        onChange={e=>handleQualificationChange(e, index)}/>
                    </div>
                    ...
                    <div>
                        ...
                        value={item.university} className="form__input"
                        onChange={e=>handleQualificationChange(e, index)} />
                    </div>
                </div>
            ...
            {formData.experiences?.map((item, index)=>(<div key={index}>
                ...
                <div className="grid grid-cols-2 gap-5 mt-5 ">
                    <div>
                        ...
                        value={item.position} className="form__input"
                        onChange={e=>handleExperienceChange(e, index)} />
                    </div>
                    ...
                    <div>
                        ...
                        value={item.hospital} className="form__input"
                        onChange={e=>handleExperienceChange(e, index)} />
                    </div>
                </div>
            ...
            {formData.timeSlots?.map((item, index)=>(<div key={index}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                    <div>
                       ...
                       <select name="day" 
                       value={item.day} className="form__input py-3.5"
                    ...
                    <div>
                        ...
                        <input type="time" name="startingTime" 
                        value={item.startingTime} className="form__input"
                        onChange={e=>handleTimeSlotChange(e, index)}
                        />
                    ...
                    <div>
                        ...
                        value={item.endingTime} className="form__input"
                        onChange={e=>handleTimeSlotChange(e, index)} />
                    </div>
        ...
        { formData.photo && (<figure className=" w-[60px] h-[60px] rounded-full border-2 border-solid border-primaryColor flex items-center justify-center">
             ...
             <div className='relative w-[130px] h-[50px]'>
              <input
               ...
               />
               <label htmlFor="customFile" className='absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer'>Upload Photo
               </label>
             </div>
        </div>
        <div className="mt-7">
